...
if (settings.nucleus == false){
    ...
    // svg_1.select('#line_11')
    // .attr('stroke', '#FFFFFF')
    // .attr('stroke-width', 1)
    // .attr('x1', xScale(x_cordi)+80)
    // .attr('y1', yScale(y_cordi)-45)
    // .attr('x2', xScale(x_cordi)+80)
    // .attr('y2', yScale(y_cordi)+55);

    // svg_1.select('#line_12')
    // .attr('stroke', '#FFFFFF')
    // .attr('stroke-width', 1)
    // .attr('x1', xScale(x_cordi)+80)
    // .attr('y1', yScale(y_cordi)-45)
    // .attr('x2', xScale(x_cordi)+80-10+5)
    // .attr('y2', yScale(y_cordi)+55-85);

    // svg_1.select('#line_13')
    // .attr('stroke', '#FFFFFF')
    // .attr('stroke-width', 1)
    // .attr('x1', xScale(x_cordi)+80)
    // .attr('y1', yScale(y_cordi)-45)
    ...
    // svg_1.select('#line_14')
    // .attr('stroke', '#FFFFFF')
    // .attr('stroke-width', 1)
    // .attr('x1', xScale(x_cordi)+80)
    // .attr('y1', yScale(y_cordi)+55)
    // .attr('x2', xScale(x_cordi)+80-10+5)
    // .attr('y2', yScale(y_cordi)-45+85);

    // svg_1.select('#line_15')
    // .attr('stroke', '#FFFFFF')
    // .attr('stroke-width', 1)
    // .attr('x1', xScale(x_cordi)+80)
    // .attr('y1', yScale(y_cordi)+55)
    ...
    .attr('stroke', '#FFFFFF')
    .attr('stroke-width', 1)
    .attr('x1', xScale(x_cordi)+heightD3/500*80)
    .attr('y1', yScale(y_cordi)-heightD3/500*45)
    .attr('x2', xScale(x_cordi)+heightD3/500*80)
    .attr('y2', yScale(y_cordi)+heightD3/500*55);
    ...
    var n = "-20"
      ...
      // svg_1.select('#text_3')
      // .attr("y", yScale(y_cordi-30+30+10) )
      // .attr("x",  xScale(x_cordi-10-20-3) )
      // .attr("dy", "1em")
      // .attr('class', 'label')
      // .style("text-anchor", "start")
      // .text(p+"eV");
      ...
      // svg_1.select('#text_4')
      // .attr("y", yScale(y_cordi+30+3+1-20) )
      // .attr("x",  xScale(x_cordi-10+22+5+10+10+12) )
      // .attr("dy", "1em")
      ...
      svg_1.select('#text_5')
      .attr("y", yScale(y_cordi+30-20) )
      .attr("x",  xScale(x_cordi-10+15+1+20+5) )
      .attr("dy", "1em")
      .attr('class', 'label')
      .style("text-anchor", "start")
      .text( "\u0394"+"E = "+ (Math.round(num_multi*100)/100).toFixed(2) );


      svg_1.select('#text_6')
      .attr("y", yScale(y_cordi+30-20) )
      .attr("x",  xScale(x_cordi-10+15+1+13+10+5+7+10) )
      .attr("dy", "1em")
      .attr('class', 'label')
      .style("text-anchor", "start")
      .text( "E-20 "+ "     eV");
...
d3bands_3_1 = () => {
  ...
  d3.selectAll('#d3-viz6-3-1').append("text")
    ...
    // svg_3_1.select('#line_12')
    // .attr('stroke', '#FEF6B6')
    // .attr('stroke-width', 3)
    // .attr('x1', xScale(x_cordi)+80+0.5)
    // .attr('y1', yScale(y_cordi)-45)
    // .attr('x2', xScale(x_cordi)+80-10)
    // .attr('y2', yScale(y_cordi)+55-85);

    // svg_3_1.select('#line_13')
    // .attr('stroke', '#FEF6B6')
    // .attr('stroke-width', 3)
    // .attr('x1', xScale(x_cordi)+80-0.5)
    // .attr('y1', yScale(y_cordi)-45)
    ...
    // svg_3_1.select('#line_14')
    // .attr('stroke', '#FEF6B6')
    // .attr('stroke-width', 3)
    // .attr('x1', xScale(x_cordi)+80+0.5)
    // .attr('y1', yScale(y_cordi)+55)
    // .attr('x2', xScale(x_cordi)+80-10)
    // .attr('y2', yScale(y_cordi)-45+80);

    // svg_3_1.select('#line_15')
    // .attr('stroke', '#FEF6B6')
    // .attr('stroke-width', 3)
    // .attr('x1', xScale(x_cordi)+80-0.5)
    // .attr('y1', yScale(y_cordi)+55)
